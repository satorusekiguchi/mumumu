...
$page_title = '補助金適正診断LP';
$page_label = '制作事例';
$hero_title = 'Subsidy Diagnosis LP';
setPageMeta(
    '補助金適正診断LP｜診断システム付きLP【制作実績】｜株式会社mumumu',
    'FORCE株式会社様の補助金適正診断LP制作事例。サイトデザイン、構築、診断システム設計。中小企業向けの補助金活用を支援するランディングページと診断システムを開発。',
    $page_title,
    $page_label,
    [
        'keywords' => '補助金,診断システム,LP制作,ランディングページ,中小企業,制作実績',
        'type' => 'article',
        'image' => SITE_URL . '/img/works/hojokin.png'
    ]
);
$breadcrumb_schema = [
    ['name' => '制作実績', 'url' => 'works/'],
    ['name' => '補助金適正診断LP', 'url' => 'works/hojokin/']
];
?>
<!DOCTYPE html>
...
<body data-page-title="<?php echo htmlspecialchars($page_title); ?>" data-page-label="<?php echo htmlspecialchars($page_label); ?>">
    ...
    <div class="inner">
      ...
      <section class="case-hero fade-in-up">
        <div class="case-hero-inner">
          <div class="case-hero-image">
            <img src="<?php echo $prefix; ?>img/works/hojokin.png" alt="補助金適正診断LP">
          </div>
          <div class="case-hero-content">
            <span class="case-category">Landing Page / Diagnostic System</span>
            <h1 class="case-title">補助金適正診断LP</h1>
            <p class="case-subtitle">あなたの会社に最適な補助金を診断。<br>中小企業の資金調達を支援するLP。</p>
            ...
            <a href="https://forceinc.kyoto/hojokin/lp/" target="_blank" rel="noopener noreferrer" class="case-link">
              サイトを見る
            </a>
          </div>
        </div>
      ...
      <section class="case-section fade-in-up">
        ...
        <div class="case-section-content">
          <p>本プロジェクトは、中小企業向けの補助金活用を支援するランディングページと診断システムの開発です。多くの中小企業が補助金制度の存在を知らなかったり、自社に適用できるかどうか分からないという課題を抱えています。</p>
          <p>この課題を解決するため、簡単な質問に答えるだけで自社に適した補助金を診断できるシステムを開発しました。ユーザーは数分の診断で、申請可能な補助金の種類と概要を把握できます。</p>
          <p>診断結果から自然に専門家への相談へとつなげる導線設計により、高いコンバージョン率を実現しています。</p>
        </div>
        
        <div class="stats-badges">
          <span class="stat-badge">中小企業向け</span>
          <span class="stat-badge">診断システム搭載</span>
          <span class="stat-badge">高CVR設計</span>
        </div>
      </section>
      ...
      <section class="case-section fade-in-up">
        ...
        <div class="features-grid">
          <div class="feature-card">
            ...
            <p class="feature-desc">補助金という堅いテーマを親しみやすく伝えるデザインを制作。信頼感と分かりやすさを両立し、ターゲットである中小企業経営者に響くビジュアルを実現しました。</p>
          </div>
          
          <div class="feature-card">
            <div class="feature-icon">Scope 02</div>
            <h3 class="feature-title">診断システム設計</h3>
            <p class="feature-desc">業種、従業員数、事業計画などの質問から、適用可能な補助金を判定するロジックを設計。ユーザーが迷わず回答できるシンプルなUIと、正確な診断結果を両立しました。</p>
          </div>
          
          <div class="feature-card">
            <div class="feature-icon">Scope 03</div>
            <h3 class="feature-title">フロントエンド実装</h3>
            <p class="feature-desc">HTML/CSS/JavaScriptでレスポンシブなLPを構築。診断システムはJavaScriptで実装し、サーバーを介さずクライアントサイドで完結する軽量な設計としました。</p>
          </div>
          
          <div class="feature-card">
            <div class="feature-icon">Scope 04</div>
            <h3 class="feature-title">CTA最適化</h3>
            <p class="feature-desc">診断結果ページから専門家への相談につなげるCTA設計を最適化。ユーザーの心理状態に合わせた訴求文言とボタン配置により、高いコンバージョン率を実現しました。</p>
          </div>
        </div>
      </section>
      ...
      <!-- 診断システムの特徴 -->
      <section class="case-section fade-in-up">
        <h2 class="case-section-title">Diagnostic System</h2>
        
        <div class="features-grid">
          <div class="feature-card">
            <div class="feature-icon">Feature 01</div>
            <h3 class="feature-title">簡単3分診断</h3>
            <p class="feature-desc">5〜7問程度の簡単な質問に答えるだけで診断完了。忙しい経営者でも気軽に利用できる設計です。</p>
          </div>
          
          <div class="feature-card">
            <div class="feature-icon">Feature 02</div>
            <h3 class="feature-title">複数補助金の同時診断</h3>
            <p class="feature-desc">ものづくり補助金、IT導入補助金、事業再構築補助金など、主要な補助金を一度に診断。見落としを防ぎます。</p>
          </div>
          
          <div class="feature-card">
            <div class="feature-icon">Feature 03</div>
            <h3 class="feature-title">詳細な結果表示</h3>
            <p class="feature-desc">診断結果では、適用可能な補助金の概要、補助率、上限額などを分かりやすく表示。次のアクションが明確になります。</p>
          </div>
          
          <div class="feature-card">
            <div class="feature-icon">Feature 04</div>
            <h3 class="feature-title">専門家への導線</h3>
            <p class="feature-desc">診断結果から自然に専門家への相談予約へとつなげる設計。ユーザーの「もっと詳しく知りたい」というニーズに応えます。</p>
          </div>
        </div>
      </section>
              ...
              <div class="page-gallery-item" data-page="top" role="button" tabindex="0" aria-label="Landing Pageを拡大表示">
                <div class="mini-browser">
                  <div class="mini-browser-header">
                    ...
                    <div class="mini-browser-url">forceinc.kyoto/hojokin/lp/</div>
                  </div>
                  <div class="mini-browser-content">
                    <img src="<?php echo $prefix; ?>img/works/hojokin-preview/hojokin-top.png" alt="補助金適正診断LP">
                  </div>
                </div>
                <div class="page-gallery-info">
                  <span class="page-gallery-name">Landing Page</span>
                  <p class="page-gallery-desc">補助金適正診断LP</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-browser browser-window">
          <div class="browser-header">
            ...
            <div class="browser-url">
              ...
              <span class="browser-url-text" id="modalUrl">https://forceinc.kyoto/hojokin/lp/</span>
            </div>
          </div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const pageData = {
        'top': {
          url: 'https://forceinc.kyoto/hojokin/lp/',
          image: '<?php echo $prefix; ?>img/works/hojokin-preview/hojokin-top.png',
          alt: '補助金適正診断LP'
        }
      };
