...
$page_label = '制作事例';
setPageMeta(
    'BESTPLAY｜オリジナル商品支援【制作実績】｜株式会社mumumu',
    'BESTPLAY様のコーポレートサイト制作事例。サイトデザイン、CMS構築、ロゴ設計、BI設計。オリジナル商品でファンダムマーケティング支援を行う企業のブランディングとWebサイト制作を担当。',
    $page_title,
    $page_label,
    [
        'keywords' => 'BESTPLAY,コーポレートサイト,Web制作,ロゴ設計,ブランディング,制作実績',
        'type' => 'article',
        'image' => SITE_URL . '/img/works/bpn.png'
    ]
);
$breadcrumb_schema = [
    ['name' => '制作実績', 'url' => 'works/'],
    ['name' => 'BESTPLAY', 'url' => 'works/bestplay/']
];
?>
<!DOCTYPE html>
...
<head>
  ...
  <style>
    ...
    .page-gallery-item:hover .gallery-overlay-content {
    ...
    <div class="inner">
      ...
      <section class="case-hero fade-in-up">
        <div class="case-hero-inner">
          <div class="case-hero-image">
            <img src="<?php echo $prefix; ?>img/works/bpn.png" alt="BESTPLAY コーポレートサイト">
          </div>
          <div class="case-hero-content">
            <span class="case-category">Corporate Site / Branding</span>
            <h1 class="case-title">BESTPLAY</h1>
            <p class="case-subtitle">ファンの想いを、カタチに。<br>オリジナル商品でファンダムマーケティングを支援。</p>
            ...
            <a href="https://bpn.jp/" target="_blank" rel="noopener noreferrer" class="case-link">
              サイトを見る
            </a>
          </div>
        </div>
      ...
      <section class="case-section fade-in-up">
        ...
        <div class="case-section-content">
          <p>BESTPLAYは、アーティストやクリエイター、企業のファンダムマーケティングを支援する会社です。オリジナルグッズの企画・製造から販売までをワンストップでサポートし、ファンとの絆を深める商品づくりを実現しています。</p>
          <p>本プロジェクトでは、会社の設立に合わせてロゴデザインからBI（ブランドアイデンティティ）設計、コーポレートサイトのデザイン・構築までを一貫して担当しました。</p>
          <p>「ファンの想いをカタチにする」という企業理念を体現するビジュアルアイデンティティと、サービスの価値を効果的に伝えるWebサイトを構築しました。</p>
        </div>
        
        <div class="stats-badges">
          <span class="stat-badge">ファンダムマーケティング</span>
          <span class="stat-badge">オリジナルグッズ製造</span>
          <span class="stat-badge">ワンストップサポート</span>
        </div>
      </section>
      ...
      <section class="page-gallery-section fade-in-up">
        ...
        <div class="gallery-intro">
          <p>サイト内の各ページデザインをご覧いただけます。クリックすると拡大表示されます。</p>
        </div>
        ...
        <div class="page-gallery-carousel-wrapper">
          <div class="page-gallery-carousel-container">
            <div class="page-gallery-carousel" id="pageGalleryCarousel">
              <div class="page-gallery-item" data-page="top" role="button" tabindex="0" aria-label="Hero Sectionを拡大表示">
                <div class="mini-browser">
                  <div class="mini-browser-header">
                    ...
                    <div class="mini-browser-url">bpn.jp</div>
                  </div>
                  <div class="mini-browser-content">
                    <img src="<?php echo $prefix; ?>img/works/bestplay-preview/hero.png" alt="BESTPLAY ヒーローセクション">
                  </div>
                </div>
                <div class="page-gallery-info">
                  <span class="page-gallery-name">Hero Section</span>
                  <p class="page-gallery-desc">ファーストビューのメインビジュアル</p>
                </div>
              </div>
              
              <div class="page-gallery-item" data-page="about" role="button" tabindex="0" aria-label="About Pageを拡大表示">
                <div class="mini-browser">
                  <div class="mini-browser-header">
                    <div class="mini-browser-dots">
                      <span></span>
                    ...
                    <div class="mini-browser-url">bpn.jp/about</div>
                  </div>
                  <div class="mini-browser-content">
                    <img src="<?php echo $prefix; ?>img/works/bestplay-preview/bestplay-about.png" alt="BESTPLAY ABOUTページ">
                  </div>
                </div>
                <div class="page-gallery-info">
                  <span class="page-gallery-name">About Page</span>
                  <p class="page-gallery-desc">企業理念・会社紹介ページ</p>
                </div>
              </div>
              
              <div class="page-gallery-item" data-page="bpnavi" role="button" tabindex="0" aria-label="BPNavi.Netを拡大表示">
                <div class="mini-browser">
                  <div class="mini-browser-header">
                    <div class="mini-browser-dots">
                      <span></span>
                    ...
                    <div class="mini-browser-url">bpnavi.net</div>
                  </div>
                  <div class="mini-browser-content">
                    <img src="<?php echo $prefix; ?>img/works/bestplay-preview/bestplay-bpnavi.png" alt="BPNavi.Net">
                  </div>
                </div>
                <div class="page-gallery-info">
                  <span class="page-gallery-name">BPNavi.Net</span>
                  <p class="page-gallery-desc">グッズ製作ナビゲーションサイト</p>
                </div>
              </div>
              
              <div class="page-gallery-item" data-page="store" role="button" tabindex="0" aria-label="BESTPLAY STOREを拡大表示">
                <div class="mini-browser">
                  <div class="mini-browser-header">
                    <div class="mini-browser-dots">
                      <span></span>
                    ...
                    <div class="mini-browser-url">bestplay.store</div>
                  </div>
                  <div class="mini-browser-content">
                    <img src="<?php echo $prefix; ?>img/works/bestplay-preview/bestplay-store.png" alt="BESTPLAY STORE">
                  </div>
                </div>
                <div class="page-gallery-info">
                  <span class="page-gallery-name">BESTPLAY STORE</span>
                  <p class="page-gallery-desc">オンラインストアページ</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-browser browser-window">
          <div class="browser-header">
            ...
            <div class="browser-url">
              ...
              <span class="browser-url-text" id="modalUrl">https://bpn.jp/</span>
            </div>
          </div>
      ...
      <section class="case-section fade-in-up">
        ...
        <div class="case-section-content">
          <p>本プロジェクトでは、ブランディングからWebサイト構築まで、幅広い領域を担当しました。</p>
        </div>
        
        <div class="features-grid">
          <div class="feature-card">
            <div class="feature-icon">Scope 01</div>
            <h3 class="feature-title">ロゴデザイン</h3>
            <p class="feature-desc">「BESTPLAY」のブランドコンセプトを表現するロゴマークをデザイン。シンプルでありながら、ファンの熱量や創造性を感じさせるデザインを追求しました。</p>
          </div>
          
          <div class="feature-card">
            <div class="feature-icon">Scope 02</div>
            <h3 class="feature-title">BI（ブランドアイデンティティ）設計</h3>
            <p class="feature-desc">ロゴの使用規定、カラーパレット、タイポグラフィなど、ブランドの一貫性を保つためのガイドラインを策定。名刺や封筒などのビジネスツールもデザインしました。</p>
          </div>
          
          <div class="feature-card">
            <div class="feature-icon">Scope 03</div>
            <h3 class="feature-title">Webサイトデザイン</h3>
            <p class="feature-desc">BIに基づいたコーポレートサイトをデザイン。サービス内容、制作実績、会社情報などを効果的に伝えるレイアウトと、ブランドの世界観を反映したビジュアル表現を実現しました。</p>
          </div>
          
          <div class="feature-card">
            <div class="feature-icon">Scope 04</div>
            <h3 class="feature-title">WordPress CMS構築</h3>
            <p class="feature-desc">WordPressをベースに、お客様が簡単に更新できるCMSを構築。ニュース、実績、ブログなどのコンテンツを自由に管理できる仕組みを実装しました。</p>
          </div>
        </div>
      </section>
      ...
      <section class="case-section fade-in-up">
        ...
        <div class="features-grid">
          <div class="feature-card">
            ...
            <h3 class="feature-title">サービス紹介</h3>
            <p class="feature-desc">オリジナルグッズの企画・製造・販売までのワンストップサービスを分かりやすく紹介。各サービスの強みと実績を効果的に伝えます。</p>
          </div>
          
          <div class="feature-card">
            <div class="feature-icon">Feature 02</div>
            <h3 class="feature-title">制作実績ギャラリー</h3>
            <p class="feature-desc">これまでに手がけたオリジナルグッズの実績をビジュアル重視で紹介。クオリティの高さと多様な対応力をアピールします。</p>
          </div>
          
          <div class="feature-card">
            <div class="feature-icon">Feature 03</div>
            <h3 class="feature-title">お問い合わせ導線</h3>
            <p class="feature-desc">各ページから自然にお問い合わせへ誘導する設計。サービスに興味を持ったユーザーがスムーズにコンタクトできるようにしました。</p>
          </div>
          
          <div class="feature-card">
            <div class="feature-icon">Feature 04</div>
            <h3 class="feature-title">ニュース・ブログ機能</h3>
            <p class="feature-desc">最新情報やノウハウを発信するためのニュース・ブログ機能を実装。SEO対策にも効果的なコンテンツマーケティングの基盤を構築しました。</p>
          </div>
        </div>
      </section>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const pageData = {
        'top': {
          url: 'https://bpn.jp/',
          image: '<?php echo $prefix; ?>img/works/bestplay-preview/bestplay-top.png',
          alt: 'BESTPLAY TOPページ'
        },
        'about': {
          url: 'https://bpn.jp/about',
          image: '<?php echo $prefix; ?>img/works/bestplay-preview/bestplay-about.png',
          alt: 'BESTPLAY ABOUTページ'
        },
        'bpnavi': {
          url: 'https://bpnavi.net/',
          image: '<?php echo $prefix; ?>img/works/bestplay-preview/bestplay-bpnavi.png',
          alt: 'BPNavi.Net'
        },
        'store': {
          url: 'https://bestplay.store/',
          image: '<?php echo $prefix; ?>img/works/bestplay-preview/bestplay-store.png',
          alt: 'BESTPLAY STORE'
        }
      };
