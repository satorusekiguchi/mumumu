...
setPageMeta(
    'プライバシーポリシー｜個人情報保護方針｜株式会社mumumu',
    '株式会社mumumuのプライバシーポリシー（個人情報保護方針）。個人情報の取り扱い、収集目的、第三者提供、開示請求等について定めています。',
    $page_title,
    $page_label,
    [
        'keywords' => 'プライバシーポリシー,個人情報保護,個人情報,株式会社mumumu',
...
<body data-page-title="<?php echo htmlspecialchars($page_title); ?>" data-page-label="<?php echo htmlspecialchars($page_label); ?>">
  ...
  <main>
    <div class="inner">
      ...
      <section id="privacy-policy" class="fade-in-up">
        <div class="privacy-content">
          <p>株式会社mumumu（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。</p>
          ...
          <p>
            住所：京都府京都市下京区大黒町227番地 第２キョートビル402<br>
            社名：株式会社mumumu<br>
            代表取締役：関口 理留<br>
            Eメールアドレス：hello@mumumu.co.jp
          </p>
        </div>
      </section>
    </div>
